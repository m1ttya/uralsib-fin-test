        ...
        <div className="mt-10">
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div className="pt-4">
              <button
                type="submit"
                className="w-full bg-gradient-purple hover:bg-gradient-purple-hover text-white py-4 px-6 rounded-xl font-medium transition-all duration-200 shadow-lg hover:shadow-xl text-base leading-6"
              >
