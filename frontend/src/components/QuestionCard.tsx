        ...
        {options.map((option, idx) => {
          ...
          return (
            <motion.button
              ...
              className={`w-full text-left py-3 px-4 sm:py-4 sm:px-5 rounded-xl border ${bgColor} ${textColor} transition-colors ring-2 ${ringColor} hover:bg-opacity-90 font-medium text-base sm:text-lg`}
            >
              {option}
            </motion.button>
          );
