  ...
  return (
    <div className="landing-page min-h-screen w-full flex flex-col items-center justify-center sm:justify-start py-0 sm:py-8 md:py-12 lg:py-16 xl:py-20 2xl:py-24 px-4 sm:px-6 md:px-8 lg:px-12">
      ...
      <motion.h1
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8 }}
        className="text-3xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl premium-heading text-center text-gray-800 mb-14 sm:mb-6 md:mb-8 lg:mb-10 lg:mb-12 max-w-2xl sm:max-w-3xl md:max-w-4xl lg:max-w-5xl px-2 sm:px-4"
      >
      ...
      <motion.button
        ...
        transition={{ duration: 0.8 }}
        onClick={onStartTest}
        className="relative bg-gradient-to-r from-primary to-primary text-white rounded-full premium-button shadow-lg hover:shadow-purple-900/25 hover:from-secondary hover:to-secondary mb-12 sm:mb-8 md:mb-12 lg:mb-16 xl:mb-20 2xl:mb-24 overflow-hidden group flex items-center justify-center whitespace-nowrap"
        style={{
