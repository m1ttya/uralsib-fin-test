  ...
  return (
    <section id="home" className="pt-0 pb-12 md:pt-4 md:pb-20 scroll-mt-24">
      <div className="container mx-auto px-4 max-w-5xl text-center">
        <img src={`${import.meta.env.BASE_URL}assets/img/1_image7.png`} alt="Уралсиб" className="mx-auto -mt-8 md:-mt-16 mb-3 h-72 md:h-96 lg:h-[32rem] w-auto"/>
        ...
        <motion.button whileHover={{scale:1.02}} whileTap={{scale:0.98}} onClick={onStart} className="px-10 py-5 rounded-full bg-primary text-white hover:bg-secondary shadow-lg">
          Начать тест
        </motion.button>
      </div>
    </section>
